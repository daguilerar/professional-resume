...
### **DevOps Engineer** — *Nationale-Nederlanden*
...
* Architected and implemented **Azure-based solutions** focused on availability, security, and maintainability for business-critical workloads.
* Automated cloud deployments with **Terraform, Bash, and Python**, improving environment consistency and reducing provisioning effort.
* Configured **CI/CD pipelines** in **Azure DevOps** and prepared development environments to support streamlined team delivery.
* Administered **Linux servers** and supported the stable operation of cloud-hosted services.
